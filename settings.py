...
class defaults:
    ...
    TOKENDB_VERSION = 2
    INFLUXDB_URLS = None
    INFLUXDB_METRICS_MEASUREMENT = "doorman_metrics"
    INFLUXDB_STATES_MEASUREMENT = "doorman_states"
    INFLUXDB_EVENTS_MEASUREMENT = None
...
INFLUXDB_URLS = getenv("INFLUXDB_URLS", defaults.INFLUXDB_URLS, parser=parse_list)
INFLUXDB_METRICS_MEASUREMENT = getenv(
    "INFLUXDB_METRICS_MEASUREMENT", defaults.INFLUXDB_METRICS_MEASUREMENT
)
INFLUXDB_STATES_MEASUREMENT = getenv(
    "INFLUXDB_STATES_MEASUREMENT", defaults.INFLUXDB_STATES_MEASUREMENT
)
INFLUXDB_EVENTS_MEASUREMENT = getenv(
    "INFLUXDB_EVENTS_MEASUREMENT", defaults.INFLUXDB_EVENTS_MEASUREMENT
)
